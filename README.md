...
*Note: The protocol structure suggests it will likely work with other models, but this is unverified. I have done my best to make this scalable to other models. Acknolegent parsing is still a work in progress.*
